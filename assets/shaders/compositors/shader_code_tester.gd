...
class_name ShaderCodeTester
## Gathered from the official documentation and modified to my personal usage
## Docs: https://docs.godotengine.org/en/stable/tutorials/rendering/compositor.html#compositor-effects
## Source: https://github.com/godotengine/godot-demo-projects/blob/master/compute/post_shader/post_process_shader.gd
